# face_recog
Simple python project for Gender and Age Detection using Convulational Neural Network 
...
-- The link to dataset // https://www.kaggle.com/datasets/ttungl/adience-benchmark-gender-and-age-classification

-- You will need to install opencv using python pip.
-- Have Fun Learning!!! :)
